...
def banner():
	print "[***]	Grabbing hashes p154	[***]"

memory_file = "WindowsXPSP2.wmem"
sys.path.append("/Users/justin/Downloads/volatility-2.3.1")		#Update the path and version of volatility
